   ...
   return (
      <Segment.Group>
         ...
         <Segment clearing attached='bottom'>
            {activity.isHost ? (
               <>
                  <Button color={activity.isCancelled ? 'green' : 'red'} floated='left' basic content={activity.isCancelled ? 'Re-active Activity' : 'Cancel Activity'} onClick={cancelActivityToggle} loading={loading} />
